...
Faustina at a comfortable measure; headings, labels and navigation stay in
Hanken Grotesk.

## Headings look like this

Lists, links and quotes all inherit from the same token set, so changing
`--prose-size` or `--prose-leading` in `_sass/_tokens.scss` adjusts every
